def main():
    ...
    if vin in vehicles_dict:
        ...
        # print(f"the manufacturer, model, and color of the vehicle: {vehicle_info}")
        manufacturer = vehicle_info[MANUFACTURER_INDEX]
        model = vehicle_info[MODEL_INDEX]
        color = vehicle_info[COLOR_INDEX]
