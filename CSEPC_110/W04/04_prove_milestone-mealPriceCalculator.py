...
# OUTPUT
print("Childs meal subtotal $",number_of_children * childs_meal_float,sep="")
print("Adult meal subtotal $",number_of_adults * adults_meal_float,sep="")
print("Subtotal: $",subtotal,sep="")
print("Sales tax $",round(sales_tax,2),sep="")
print("Meals total including sales tax $",round(total_price_of_meal,2),sep="")

user_input_amount = float(input("What is the payment amount? $"))
print("change: $",round(user_input_amount - total_price_of_meal,2),sep="")