...
print( "On your next birthday, you will be ", user_Age + 1,"\n")

#02
number_of_egg_cartons = int(input("How many egg cartons do you have? "))
print("you have", number_of_egg_cartons * 12,"eggs","\n")
